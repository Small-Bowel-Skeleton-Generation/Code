...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--cond', type=bool, default=False, help='werther using condition')
        self.parser.add_argument('--cond_dir', type=str, default='/mnt/gemlab_data_2/User_database/liangzhichao/simulated_mask_data', help='condition file')
        ...
        self.parser.add_argument("--local-rank", dest="local_rank", type=int, default=0,
