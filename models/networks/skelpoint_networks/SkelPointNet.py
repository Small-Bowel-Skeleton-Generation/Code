...
class SkelPointNet(nn.Module):
    ...
    def __init__(self, num_skel_points=512, input_channels=3, use_xyz=True):
    ...
    def forward(self, input_pc, compute_graph=False):
        ...
        if compute_graph:
            A, valid_Mask, known_Mask = self.init_graph(input_pc[..., 0:3], skel_xyz)
            return skel_xyz, sample_xyz, weights, shape_cmb_features, A, valid_Mask, known_Mask
        else:
            return skel_xyz, shape_cmb_features
