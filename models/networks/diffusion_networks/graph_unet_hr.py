...
class UNet3DModel(nn.Module):
    ...
    def forward(self, x = None, doctree = None, unet_lr = None, timesteps = None, label = None, context = None, graph_octree = None, as_middle=False, **kwargs):
        """
        ...
        if unet_lr is not None:
            ...
            h_lr = unet_lr.forward_as_middle(h, doctree, timesteps, label, context, graph_octree)
