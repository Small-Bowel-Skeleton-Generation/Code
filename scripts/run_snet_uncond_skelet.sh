...
vq_ckpt="/home/data/liangzhichao/Code/octfusion-main/logs/skeleton4_union/test_snet_lr1e-3/ckpt/vae_steps-latest.pth"
...
#if [ $mode = "train" ]; then
##    pretrain_ckpt="saved_ckpt/diffusion-ckpt/rifle/df_steps-split.pth"
#    pretrain_ckpt="/home/data/liangzhichao/Code/octfusion-main/logs/skeleton5_union/union_2t_test_lr2e-4/ckpt/df_steps-latest.pth"
#else
#    ckpt="/home/data/liangzhichao/Code/octfusion-main/logs/rifle_union/union_2t_test_lr2e-4/ckpt/df_steps-latest.pth"
#fi
...
cmd="train_uncond.py --name ${name} --logs_dir ${logs_dir} --gpu_ids ${gpu_ids} --mode ${mode} \
