...
def config_dataloader(opt):
	...
	flags_train.filelist = os.path.join(flags_train.filelist, 'train.txt')
	flags_test.filelist = os.path.join(flags_test.filelist, 'test.txt')

	flags_train.cond_dir = opt.cond_dir
	flags_test.cond_dir = opt.cond_dir
...
def get_dataloader(opt, flags, drop_last = False):
	...
	data_loader = torch.utils.data.DataLoader(
		...
		sampler=sampler, collate_fn=collate_fn, pin_memory=False, drop_last=drop_last)
